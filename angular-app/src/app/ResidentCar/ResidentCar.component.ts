...
@Component({
  selector: 'app-ResidentCar',
  templateUrl: './ResidentCar.component.html',
  styleUrls: ['./ResidentCar.component.css'],
})

//ResidentComponent class
export class ResidentCarComponent implements OnInit {

  //define variables
  myForm: FormGroup;

  private resident: Resident;
  private residentID = "ID101";
  ...
  delete(): void {
    ...
    .subscribe(() => {
      this.successMessage = "Consumer Deleted";
    }, (error) => this.errorMessage = error);
  }
